...
<template>
    <transition name="slide">
        <!-- 退还押金 -->
        <div class="depositViewPage" v-if="depositType.type == 0">
            <van-nav-bar
                fixed
                title="押金管理"
                left-arrow
            ...
            <div class="backdMoney">
                ...
                >
                    对押金规则不清楚？</a
                >
                <van-button type="default" @click="refunddeposit()"
                    >退还
                </van-button>
            </div>
        </div>
        <!-- 缴纳押金 -->
        <div class="depositViewPage toPayDeposit" v-if="depositType.type == 1">
            <van-nav-bar
                fixed
                title="缴纳押金"
                left-arrow
            ...
            <div class="payway">
                ...
                <div class="payBtn">
                    ...
                    >
                        对押金规则不清楚？</a
                    >
                    <van-button type="default" @click="payMoney">
                        <span>支付</span>
                    </van-button>
                </div>
            </div>
